        ...
        <div class="flex items-center justify-between md:container md:mb-8">
          <div class="mb-6 md:mb-0">
            <a href="#" class="flex items-center">
              <img class="" src="logo.png" width={90} />
            </a>
          </div>

          <div class="mb-6 md:mb-0">
            <ul class="flex flex-row space-x-3 text-sm text-white md:p-0 lg:p-0">
              <li>
                <div class="rounded-full bg-white bg-opacity-15 p-1 md:p-2 cursor-pointer">
                  <svg
                    class="h-3 w-3 fill-white hover:fill-primary md:h-4 md:w-4"
